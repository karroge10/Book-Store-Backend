...
function editUser(name: any, id: any) {
    return new Promise((resolve, reject) => {
...
function deleteUserBooks(id: any) {
    return new Promise((resolve, reject) => {
...
function giveBook(userId: any, bookId: any) {
    return new Promise((resolve, reject) => {
...
function returnBook(userId: any, bookId: any) {
    return new Promise((resolve, reject) => {
